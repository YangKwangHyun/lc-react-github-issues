            ...
            {isSuccess && (
                <>
                    ...
                    <div className="issue-details">
                        <a href="">{issue.user.login}</a> opened this
                        issue {formatDistance(new Date(issue.created_at), new Date(), {addSuffix: true,})}
                    </div>
                </>
            )}
                ...
                <div className="comment-container">
                    ...
                    <div className="comment">
                        <div className="comment-heading">
                            <a href={issue.user.html_url}>mdaj06</a> commented {formatDistance(new Date(issue.created_at), new Date(), {addSuffix: true,})}
                        </div>
